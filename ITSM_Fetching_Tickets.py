...
#         options.add_argument('--ignore-certificate-errors')
    ...
    for i in range(1,2):
        ...
        try:
            ...
            if driver.find_element_by_xpath('//*[@id="BodyContentPlaceHolder_gvMyTickets"]/tbody/tr['+str(i+1)+']/td[4]/h4/span').text == 'New':
               
                # This stores the incident id
                inc_id = driver.find_element_by_xpath('//*[@id="BodyContentPlaceHolder_gvMyTickets"]/tbody/tr['+str(i+1)+']/td[2]/div[2]/a[1]').text
                
                #This clicks on the incident id
                driver.find_element_by_xpath('//*[@id="BodyContentPlaceHolder_gvMyTickets"]/tbody/tr['+str(i+1)+']/td[2]/div[2]/a[1]').click()
                time.sleep(2)
